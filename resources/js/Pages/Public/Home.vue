    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
          <h2 class="text-3xl lg:text-4xl font-bold text-gray-900">Why Choose HBCI?</h2>
          <p class="mt-4 text-gray-600 max-w-2xl mx-auto">We combine hands-on training with industry expertise to prepare you for a successful career.</p>
        </div>
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-amber-200 transition">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Internationally Accredited</h3>
            <p class="text-gray-600 leading-relaxed">Earn certifications recognized globally by City & Guilds and Luxury Hospitality Academy.</p>
          </div>
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-amber-200 transition">
            <div class="w-14 h-14 bg-amber-100 rounded-xl flex items-center justify-center mb-6">
              <svg class="w-7 h-7 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Hands-On Training</h3>
            <p class="text-gray-600 leading-relaxed">Train in fully-equipped professional kitchens with real-world culinary experiences.</p>
          </div>
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-amber-200 transition">
            <div class="w-14 h-14 bg-amber-100 rounded-xl flex items-center justify-center mb-6">
              <svg class="w-7 h-7 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Hospitality Network</h3>
            <p class="text-gray-600 leading-relaxed">Gain industry connections through our partnerships with leading hotels and restaurants.</p>
          </div>
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-amber-200 transition">
            <div class="w-14 h-14 bg-amber-100 rounded-xl flex items-center justify-center mb-6">
              <svg class="w-7 h-7 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p class="text-gray-600 leading-relaxed">Learn from industry professionals with years of culinary and hospitality experience.</p>
          </div>
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-amber-200 transition">
            <div class="w-14 h-14 bg-amber-100 rounded-xl flex items-center justify-center mb-6">
              <svg class="w-7 h-7 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Career Support</h3>
            <p class="text-gray-600 leading-relaxed">Get guidance with job placement assistance and career development resources.</p>
          </div>
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:shadow-lg hover:border-amber-200 transition">
            <div class="w-14 h-14 bg-amber-100 rounded-xl flex items-center justify-center mb-6">
              <svg class="w-7 h-7 text-amber-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <h3 class="text-xl font-semibold text-gray-900 mb-3">Study Local, Go Global</h3>
            <p class="text-gray-600 leading-relaxed">Quality education right here in Lesotho with pathways to international opportunities.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          <h2 class="text-3xl lg:text-4xl font-bold text-gray-900">What Our Alumni Say</h2>
        </div>
        <div class="grid md:grid-cols-3 gap-8">
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100">
            ...
            <p class="text-gray-700 italic mb-6">"The hands-on training at HBCI gave me the confidence to work in top kitchens. Within months of graduating, I secured a position at a renowned restaurant in Cape Town."</p>
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 bg-amber-200 rounded-full flex items-center justify-center text-amber-800 font-semibold text-sm">LM</div>
              <div>
                <p class="font-semibold text-gray-900">Lerato Mokoena</p>
                <p class="text-sm text-gray-500">Professional Chef, Class of 2023</p>
              </div>
            </div>
          </div>
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100">
            ...
            <p class="text-gray-700 italic mb-6">"The instructors' industry experience is unmatched. They don't just teach theory—they share real-world insights that helped me excel in my hotel management career."</p>
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 bg-amber-200 rounded-full flex items-center justify-center text-amber-800 font-semibold text-sm">TK</div>
              <div>
                <p class="font-semibold text-gray-900">Thabo Kolobe</p>
                <p class="text-sm text-gray-500">Hotel Manager, Class of 2022</p>
              </div>
            </div>
          </div>
          <div class="bg-gray-50 p-8 rounded-2xl border border-gray-100">
            ...
            <p class="text-gray-700 italic mb-6">"Thanks to HBCI's international certifications, I had job offers from luxury hotels even before my graduation ceremony. The investment was worth it."</p>
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 bg-amber-200 rounded-full flex items-center justify-center text-amber-800 font-semibold text-sm">MM</div>
              <div>
                <p class="font-semibold text-gray-900">Mamokhele Rali</p>
                <p class="text-sm text-gray-500">Pastry Chef, Class of 2024</p>
              </div>
            </div>
          </div>
        </div>
