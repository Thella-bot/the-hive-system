  ...
  <PublicLayout>
    ...
    <section class="relative bg-gradient-to-br from-amber-600 to-amber-700 text-white py-20 lg:py-28 overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="mt-4 text-lg text-white/80 max-w-2xl mx-auto">Have questions about our programmes or admissions? We'd love to hear from you.</p>
      </div>
    </section>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-5 gap-12 lg:gap-16">
          ...
          <div class="lg:col-span-3">
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-8 lg:p-10">
              <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">Send Us a Message</h2>
              <p class="text-gray-500 dark:text-gray-400 text-sm mb-8">Fill in the form below and we'll get back to you within 2 business days.</p>
              ...
              <form @submit.prevent="submit" class="space-y-5">
                <div class="grid sm:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input v-model="form.name" type="text" id="name" required
                      class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 text-gray-900 dark:text-gray-100 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition"
                ...
                <div>
                  ...
                  <textarea v-model="form.message" id="message" rows="6" required
                    class="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 text-gray-900 dark:text-gray-100 dark:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition resize-none"
                    :class="form.errors.message ? 'border-red-400' : ''"
                    placeholder="Tell us how we can help you..."></textarea>
                  <div v-if="form.errors.message" class="text-red-600 dark:text-red-400 text-xs mt-1">{{ form.errors.message }}</div>
                </div>
                <div>
                  <button type="submit" :disabled="form.processing"
                    class="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-amber-600 to-amber-700 text-white font-semibold rounded-lg hover:from-amber-700 hover:to-amber-800 transition disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-0.5">
                    <span v-if="form.processing">Sending...</span>
                    <span v-else>Send Message</span>
                    <svg v-if="!form.processing" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
                  </button>
                </div>
              </form>
            </div>
          ...
          <div class="lg:col-span-2 space-y-8">
            <!-- Contact Cards -->
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 space-y-5">
              <div class="flex items-start gap-4">
                ...
                <div>
                  <h3 class="font-semibold text-gray-900 dark:text-white">Visit Us</h3>
                  <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">Maseru, Lesotho</p>
                </div>
              </div>
              <div class="flex items-start gap-4">
                <div class="w-10 h-10 bg-amber-100 dark:bg-amber-900/40 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  ...
                  <p class="text-gray-600 dark:text-gray-400 text-sm mt-1">info@hbci.co.ls</p>
                </div>
              </div>
              <div class="flex items-start gap-4">
                <div class="w-10 h-10 bg-amber-100 dark:bg-amber-900/40 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <!-- Office Hours -->
            <div class="bg-gray-50 dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6">
              <h3 class="font-semibold text-gray-900 dark:text-white mb-4">Office Hours</h3>
              <div class="space-y-2 text-sm">
                <div class="flex justify-between">
                  <span class="text-gray-600 dark:text-gray-400">Monday — Friday</span>
                  <span class="text-gray-900 dark:text-white font-medium">8:00 AM — 4:30 PM</span>
                </div>
                <div class="flex justify-between">
                  <span class="text-gray-600 dark:text-gray-400">Saturday</span>
                  <span class="text-gray-900 dark:text-white font-medium">9:00 AM — 1:00 PM</span>
                </div>
                <div class="flex justify-between">
            ...
            <!-- Social -->
            <div>
              <h3 class="font-semibold text-gray-900 dark:text-white mb-3">Follow Us</h3>
              <div class="flex gap-3">
                <a href="#" class="w-10 h-10 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500 dark:text-gray-400 hover:bg-amber-100 dark:hover:bg-amber-900/40 hover:text-amber-600 dark:hover:text-amber-400 transition">
