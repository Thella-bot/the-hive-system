<template>
  <AppLayout title="Cohorts" description="Student groups by department and academic year">
...
const applyFilters = () => router.get(route('cohorts.index'), filters.value, { preserveState: true, replace: true })
