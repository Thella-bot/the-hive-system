...
const form = useForm({
    ...
    sort_order: props.material.sort_order,
});

const submit = () => {
    form.patch(route('hive.modules.courses.update', [props.module, props.material]));
};
</script>

<template>
    <Head title="Edit Course Material" />
    <HiveLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Course Material</h2>
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            />
                            <p v-if="form.errors.sort_order" class="text-red-500 text-sm mt-1">{{ form.errors.sort_order }}</p>
                        </div>
