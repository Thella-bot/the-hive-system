...
const form = useForm({
    module_id: props.slot.module_id,
    instructor_id: props.slot.instructor_id,
    room_id: props.slot.room_id || '',
    day_of_week: props.slot.day_of_week,
    start_time: props.slot.start_time,
    end_time: props.slot.end_time,
    semester: props.slot.semester,
    academic_year: props.slot.academic_year,
    start_date: props.slot.start_date,
    end_date: props.slot.end_date,
    recurrence: props.slot.recurrence,
    is_active: props.slot.is_active,
});

const submit = () => {
    form.patch(route('hive.timetable.update', props.slot.id));
};
</script>
