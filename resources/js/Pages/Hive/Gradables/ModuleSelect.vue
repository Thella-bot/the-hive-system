...
<template>
    ...
    >
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 mb-2">{{ typeLabel }}</h1>
            <p class="text-gray-600">Select a module to view assessments</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
                ...
                <div class="flex items-center justify-between text-xs text-gray-500">
                    ...
                    <span class="text-amber-600 font-medium">View {{ typeLabel }}</span>
                </div>
            </Link>
        </div>
