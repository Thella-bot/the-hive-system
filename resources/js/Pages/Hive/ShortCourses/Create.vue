...
const form = useForm({
  ...
  courseable_type: 'App\\Models\\Department',
  courseable_id: props.departmentId ?? '',
});
...
const submit = () => {
  form.post(route('hive.short-courses.store'));
};
</script>

<template>
  <Head title="Create Short Course" />

  <HiveLayout title="Create Short Course" description="Add a new workshop or short course">
      ...
      <form @submit.prevent="submit" class="bg-white rounded-xl shadow p-6 space-y-6">
        ...
        <div>
          ...
          <TextInput id="title" type="text" class="mt-1 block w-full" v-model="form.title" required
            placeholder="e.g., Bread Making Basics" />
        ...
        <div>
          ...
          <textarea id="description" v-model="form.description"
            ...
            rows="3" placeholder="Brief description of what participants will learn..."></textarea>
