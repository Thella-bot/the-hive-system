...
const form = useForm({
  ...
  delivery_mode: props.shortCourse.delivery_mode ?? 'in_person',
  meeting_platform: props.shortCourse.meeting_platform ?? '',
  meeting_link: props.shortCourse.meeting_link ?? '',
  location: props.shortCourse.location ?? '',
