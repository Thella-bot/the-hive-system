...
const form = ref({
  user_id: props.invoice.user?.id || '',
  programme_id: props.invoice.programme?.id || '',
  type: props.invoice.type || 'registration',
  amount: props.invoice.amount || '',
  description: props.invoice.description || '',
  due_date: props.invoice.due_date || '',
  academic_year: props.invoice.academic_year || '',
  semester: props.invoice.semester || 1,
...
const submit = () => {
  ...
  router.patch(route('hive.finance.invoices.update', props.invoice.id), form.value, {
...
<template>
  ...
  <HiveLayout title="Edit Invoice" description="Edit invoice details">
    <form @submit.prevent="submit" class="space-y-6">
      ...
      <div class="flex justify-end gap-4">
        <Link :href="route('hive.finance.invoices.show', props.invoice.id)"
