...
const applyFilters = () => router.get(route('hive.finance.budgets.index'),
  { search: search.value },
...
<template>
  <HiveLayout title="Budgets" description="Manage department budgets and allocations">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <tr v-for="budget in budgets.data" :key="budget.id" class="hover:bg-amber-50 dark:hover:bg-amber-900/20 transition-colors">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                <Link :href="route('hive.finance.budgets.show', budget.id)" class="p-1 text-gray-500 hover:text-amber-600">
      ...
      <Pagination :links="budgets.links" :meta="budgets" />
    </div>
  </HiveLayout>
</template>