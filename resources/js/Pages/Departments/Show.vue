<template>
  <AppLayout :title="department.name" :description="department.description ?? 'No description'">
    <template #header-actions>
      <div class="flex items-center gap-3">
        <Link :href="route('departments.index')" class="text-sm text-gray-500 hover:text-gray-700 font-medium">
          ← Departments
        </Link>
        <Link v-if="can('edit-departments')" :href="route('departments.edit', department.id)"
      ...
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div class="xl:col-span-2 bg-white rounded-xl border border-gray-200">
          <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            ...
            <Link v-if="can('create-cohorts')" :href="route('cohorts.create')"
        ...
        <div class="bg-white rounded-xl border border-gray-200">
          ...
          <div class="divide-y divide-gray-50">
            ...
            <div v-for="member in department.staff" :key="member.id"
              ...
              <Link :href="route('users.show', member.user_id)"
