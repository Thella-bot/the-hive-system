<template>
  <AppLayout title="Departments" description="Manage culinary departments and their heads">
    <template #header-actions>
      <Link v-if="can('create-departments')" :href="route('departments.create')"
      ...
      <div v-for="dept in departments.data" :key="dept.id"
        ...
        <div class="p-5">
          ...
          <div class="flex items-center gap-2 pt-3 border-t border-gray-100">
            ...
            <Link v-if="can('edit-departments')" :href="route('departments.edit', dept.id)"
...
const can = (permission) => usePage().props.auth.user?.permissions?.includes(permission) ?? false
</script>
