        ...
        <div class="px-4 py-4 space-y-1">
          ...
          <div class="pt-4 flex flex-col gap-3">
            <Link
              :href="route('apply')"
              @click="mobileMenuOpen = false"
              class="block text-center px-5 py-3 bg-amber-600 text-white text-sm font-semibold rounded-lg hover:bg-amber-700 transition"
            >
              Apply Now
            </Link>
            <Link
    ...
    <footer class="bg-gray-900 text-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div class="lg:col-span-2">
            <Link :href="route('home')" class="inline-block">
              <img src="/images/hbci-logo.png" alt="HBCI" class="h-12 w-auto brightness-0 invert" />
            </Link>
            ...
            <div class="mt-6 flex gap-4">
              <a href="#" class="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center text-gray-400 hover:bg-amber-600 hover:text-white transition">
        ...
        <div class="mt-12 pt-8 border-t border-gray-800">
          <p class="text-xs text-gray-500 text-center mb-6">Accredited & Affiliated With</p>
          <div class="flex flex-wrap items-center justify-center gap-8">
            <img src="/images/cchpl-alt-logo.png" alt="CCHPL" class="h-12 w-auto opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition" />
            <img src="/images/lca-logo.png" alt="LCA" class="h-12 w-auto opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition" />
            <img src="/images/culinary-institute-logo.png" alt="City & Guilds" class="h-12 w-auto opacity-60 grayscale hover:grayscale-0 hover:opacity-100 transition" />
          </div>
        </div>
